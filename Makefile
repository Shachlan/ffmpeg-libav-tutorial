...
transcoding: ./*.cpp ./Transcoding/*.cpp
	...
	&& g++ -g -std=c++17 -w -o build/transcoding-xsimd -lboost_date_time -lavformat -lavcodec -lswscale -lz -lglfw -lavutil -framework OpenGL *.cpp ./Transcoding/*.cpp -I./ -I ./build -include all.hpp \
