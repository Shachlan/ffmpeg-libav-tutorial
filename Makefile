...
transcoding: clean
	...
	&& g++ -g -std=c++14 -Wall -DLOGGING_LEVEL_DEBUG=0 -o build/transcoding -lavformat -lavcodec -lswscale -lz -lglfw -lavutil -framework OpenGL *.c *.cpp -I ./build -include all.hpp \
