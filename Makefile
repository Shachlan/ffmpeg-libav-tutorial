...
transcoding: clean
	g++ -g -Wall -o build/transcoding -lavformat -lavcodec -lswscale -lz -lglfw -lavutil -framework OpenGL transcoding.cpp openGLShading.cpp preparation.c rationalExtensions.c \
